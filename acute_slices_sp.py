...
# recording 
rec_numbers = ["00","01","03", "04", "05", "06", "07", "08", "09", "10", "11"]
stim_intensities = [80, 90, 100, 120, 140, 180, 200, 300, 250]
amplitudes = []
slope_global = []
...
for rec in rec_numbers:
    ...
    file_path = f"acute_slices_120826/20260805_KCNQ35_Line34 _cell2_activation_00{rec}.abf"
    slopes = []
    ...
    plt.tight_layout()
    plt.savefig(f"acute_slices_plots/sp/all_sweeps{rec}.png", dpi=300)
    plt.close()
...
plt.grid()
plt.savefig(f"acute_slices_plots/io_curve_sp.png", dpi=300)
